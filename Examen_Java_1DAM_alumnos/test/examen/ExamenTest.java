...
public class ExamenTest {
    ...
    public void testBuscarContacto() {
        ...
        agenda.agregarContacto(new Contacto("pp", "333", "carla@mail.com"));

        List<Contacto> resultados = agenda.buscarContacto("Carlos");
    ...
    public void testContarPalabras() {
        ...
        int resultado = examen.ContadorPalabras.contarPalabras(ruta);
